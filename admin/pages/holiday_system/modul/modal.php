			...
			<form class="form-horizontal" method="POST" action="addEvent.php">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" name="title" class="form-control" id="title" placeholder="หัวข้อกิจกรรม">
					</div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
					<label for="start" class="col-sm-2 control-label">วันที่</label>
					<div class="col-sm-10">
					  <input type="text" name="start" class="form-control" id="start" readonly>
					</div>
				  </div>
				  <div class="form-group">
					<label for="end" class="col-sm-2 control-label">ถึงวันที่</label>
					<div class="col-sm-10">
